...
import { KeyRound, AlertCircle, Loader, Mail, Eye, EyeOff } from "lucide-react";
          ...
          <form onSubmit={resetPassword} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                required
                minLength={6}
                className="w-full px-4 py-2 pr-11 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none"
